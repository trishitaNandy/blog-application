        ...
        <Card className='mt-2 border-0 rounded-0 shadow-sm'>
            <CardBody>
                ...
                <Container className='text-center'>
                    <img style={{ maxWidth: '200px', maxHeight: '200px' }} src={user.image ? user.image : 'https://www.transparentpng.com/thumb/user/gray-user-profile-icon-png-fP8Q1P.png'} alt="user profile picture" />
                </Container>
